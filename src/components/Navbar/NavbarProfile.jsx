...
const NavProfile = () => {
  ...
  useEffect(() => {
   ...
   const profileImage = user?.profileImage || "/assets/images/profile.png";
  ...
  return (
    <div className="_header_nav_profile"  ref={dropdownRef}>
      <div className="_header_nav_profile_image"   onClick={() => fileInputRef.current.click()}>
        <img src={profileImage} alt="Image" className="_nav_profile_img _nav_profile_img_round" />
         <input
        type="file"
        ref={fileInputRef}
        style={{ display: "none" }}
      ...
      <div className="_header_nav_dropdown"  onClick={() => setDropdownOpen(!dropdownOpen)}>
      ...
      <div id="_prfoile_drop"  className={`_nav_profile_dropdown _profile_dropdown ${dropdownOpen ? 'show': ''}`}>
        <div className="_nav_profile_dropdown_info">
          <div className="_nav_profile_dropdown_image">
            <img src={profileImage} alt="Image" className="_nav_drop_img _nav_profile_img_round" />
          </div>
        ...
        <ul className="_nav_dropdown_list">
          ...
          <li className="_nav_dropdown_list_item">
            <a href="#0" className="_nav_dropdown_link" onClick={logout}>
              <div className="_nav_drop_info">
                <span>
